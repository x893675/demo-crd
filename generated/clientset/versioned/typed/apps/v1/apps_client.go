...
import (
	...
	"github.com/x893675/demo-crd/generated/clientset/versioned/scheme"
	rest "k8s.io/client-go/rest"
)

type AppsV1Interface interface {
	RESTClient() rest.Interface
	ConfigDeploymentsGetter
	SimpleDeploymentsGetter
}

// AppsV1Client is used to interact with features provided by the apps.x893675.github.io group.
type AppsV1Client struct {
	restClient rest.Interface
}

func (c *AppsV1Client) ConfigDeployments(namespace string) ConfigDeploymentInterface {
	return newConfigDeployments(c, namespace)
}

func (c *AppsV1Client) SimpleDeployments(namespace string) SimpleDeploymentInterface {
