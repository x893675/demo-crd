...
//+kubebuilder:webhook:path=/mutate-demo-x893675-github-io-v1-guestbook,mutating=true,failurePolicy=fail,sideEffects=None,groups=demo.x893675.github.io,resources=guestbooks,verbs=create;update,versions=v1,name=mguestbook.kb.io,admissionReviewVersions=v1
...
//+kubebuilder:webhook:path=/validate-demo-x893675-github-io-v1-guestbook,mutating=false,failurePolicy=fail,sideEffects=None,groups=demo.x893675.github.io,resources=guestbooks,verbs=create;update,versions=v1,name=vguestbook.kb.io,admissionReviewVersions=v1
